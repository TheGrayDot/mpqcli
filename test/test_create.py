...
def test_create_mpq_from_file(binary_path, generate_test_files):
    """
    Test MPQ archive creation from a file.
    ...
    verify_archive_file_content(binary_path, target_file, {"test.txt"})
...
def test_create_mpq_from_file_with_nameinarchive_parameter(binary_path, generate_test_files):
    ...
    verify_archive_file_content(binary_path, target_file, {"messages\\important.txt"})
